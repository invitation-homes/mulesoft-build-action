...
async function main() {
  ...
  const MULESOFT_CONNECT_APP_ID = process.env.MULESOFT_CONNECT_APP_ID;
  const MULESOFT_CONNECT_APP_SECRET = process.env.MULESOFT_CONNECT_APP_SECRET;
  ...
  try {
    ...
    if (await maven.build(SECRET_KEY, MULESOFT_NEXUS_USER, MULESOFT_NEXUS_PASSWORD, MULESOFT_CONNECT_APP_ID , MULESOFT_CONNECT_APP_SECRET)) {
